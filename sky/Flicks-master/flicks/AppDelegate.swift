...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let SkyNavigationCtrl = storyboard.instantiateViewController(withIdentifier: "moviesNavigationCtrl") as! UINavigationController
        let SkyVC = SkyNavigationCtrl.topViewController as! MoviesViewController
        SkyVC.title = "Cine SKY"
        SkyVC.endpoint = "now_playing"
        SkyNavigationCtrl.tabBarItem.image = #imageLiteral(resourceName: "Film")
        ...
        topRatedVC.title = "Mais votados"
        topRatedNavigationCtrl.tabBarItem.image = #imageLiteral(resourceName: "Star")
        
        let tabBarCtrl = UITabBarController()
        tabBarCtrl.viewControllers = [SkyNavigationCtrl, topRatedNavigationCtrl]
